Pod::Spec.new do |s|
  ...
  s.description      = <<-DESC
    VKASampleSDK is a lightweight and scalable iOS advertising Adapter designed to deliver high-quality, optimized advertisements. It helps developers monetize their applications efficiently while maintaining a smooth and engaging user experience.
  DESC
...
s.vendored_frameworks = 'VKASampleSDK.xcframework'
